...
| Plattform | Datei |
|----------|------|
| Windows (empfohlen) | `elyvo-assist-X.Y.Z-windows-x64-setup.exe` |
...
1. Lade das Installationsprogramm `...-setup.exe` (NSIS) herunter — oder die `.msi`-Datei, falls deine Organisation eine MSI-Bereitstellung bevorzugt.
